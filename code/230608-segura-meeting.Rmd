...
rectangle_integral <- function(animal_micron_lengths_vector, binwidth=2){
  values <- data.frame(animal_micron_lengths_vector)
  
  hist_plot <- ggplot(values, aes(x = values)) +
    geom_histogram()
  ...
  # then calculate itegral by multiplying every number in count vector by binwidth
...
# then use lapply to apply it to every animals
